  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userInfo.is_admin) {
        localStorage.setItem("adminLastLogin", loginTime);
        console.log("🔧 Admin login tracked:", loginTime);
      } else {
        localStorage.setItem("userLastLogin", loginTime);
        console.log("👤 User login tracked:", loginTime);
      }

      console.log("✅ Login successful:", userInfo);
      console.log("🔍 userInfo.is_admin:", userInfo.is_admin);
      console.log("🔍 typeof userInfo.is_admin:", typeof userInfo.is_admin);
      ...
      // Add small delay to ensure localStorage is properly set
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="text-center">
          <h2 className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
            WiseTech
          </h2>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white bg-opacity-80 backdrop-filter backdrop-blur-lg py-8 px-4 shadow-lg sm:rounded-xl sm:px-10 border border-gray-200 transform transition-all duration-300 hover:shadow-xl">
            <h2 className="text-center text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 mb-6">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="remember-me"
                    className="ml-2 block text-sm font-medium text-indigo-700"
                  >
                    Remember me
                  </label>
                </div>
                ...
                <div className="text-sm">
                  <a
                    href="#"
                    className="font-bold text-indigo-600 hover:text-indigo-500 hover:underline transition-all duration-300"
                  >
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 text-center">
                <Link
                  to="/register"
                  className="inline-block font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105"
                >
