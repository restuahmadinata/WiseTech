...
const Tablets = () => {
    ...
    try {
      ...
      const mockTablets = [
        ...
        },
        {
          ...
          price: 799,
          rating: 4.6,
          image_url: 'https://placehold.co/300x200/4F46E5/FFFFFF?text=Galaxy+Tab+S9',
        ...
        },
        {
          ...
          price: 1099,
          rating: 4.8,
          image_url: 'https://placehold.co/300x200/4F46E5/FFFFFF?text=iPad+Pro+12.9',
        ...
        },
        {
          ...
          price: 999,
          rating: 4.4,
          image_url: 'https://placehold.co/300x200/4F46E5/FFFFFF?text=Surface+Pro+9',
        ...
        },
        {
          ...
          price: 299,
          rating: 4.2,
          image_url: 'https://placehold.co/300x200/4F46E5/FFFFFF?text=Tab+P11+Plus',
          release_date: '2023-04-05',
          description: 'Affordable tablet with good performance for entertainment and work.',
          screen_size: '11"'
        },
        {
          id: 18,
          ...
          price: 149,
          rating: 4.1,
          image_url: 'https://placehold.co/300x200/4F46E5/FFFFFF?text=Fire+HD+10',
          release_date: '2023-06-20',
          description: 'Budget-friendly tablet perfect for streaming and reading.',
          screen_size: '10.1"'
        }
      ];
  ...
  const brandsToShow = ['Apple', 'Samsung', 'Microsoft', 'Lenovo', 'Amazon', 'Huawei', 'Xiaomi', 'Google'];
              ...
              {tablets.map((tablet) => (
                ...
                >
                  <div className="aspect-w-4 aspect-h-3 bg-gray-200 overflow-hidden">
                    <img 
                      src={tablet.image_url || tablet.image || 'https://placehold.co/300x200/4F46E5/FFFFFF?text=' + encodeURIComponent(tablet.name)} 
                      alt={tablet.name}
                      className="w-full h-full object-center object-cover group-hover:opacity-90 transition-opacity duration-300"
                      onError={(e) => {
                        e.target.src = 'https://placehold.co/300x200/4F46E5/FFFFFF?text=' + encodeURIComponent(tablet.name);
                      }}
                    />
                  </div>
                  <div className="p-5 flex-grow flex flex-col">
                    <div>
                      ...
                      {tablet.screen_size && (
                        <p className="mt-1 text-xs text-purple-600 font-medium">{tablet.screen_size}</p>
                      )}
                    </div>
